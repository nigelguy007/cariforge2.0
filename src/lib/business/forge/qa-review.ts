...
function getClient(): Anthropic | null {
  ...
  // ceiling this way. getQAReview already treats any AI failure as fine —
  // it degrades to { status: 'unavailable' } and a human still decides the
  // gate directly — so there is no upside to the SDK spending minutes
  // retrying before honoring that.
  cachedClient = apiKey
    ? new Anthropic({
        apiKey,
